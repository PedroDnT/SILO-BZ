...
_ORDER: dict[str, str] = {
    ...
    # A restatement's changed fields, newest restated delivery first, then by
    # field_path within one document.
...
_TAGS: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"^(fund_documents|fund_restatements|fund_restatement_diff)$"), "FNET documents"),
