...
Agents cannot generate API keys. One project anon/public JWT; never service_role.
If the anon key is not in the page, say so and show the `coverage` / `panel` method
without inventing live market numbers.
