...
- [ ] **INFRA-02**: Three isolated schemas exist (`cvm`, `bacen`, `b3_calc`) with per-service DB users
...
- [ ] **INFRA-06**: ORM table definitions live in `src/db/models/` as shared source of truth
