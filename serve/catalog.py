...
# v31: the FIDC structure tabs reach the API (backlog B3). Two functions over
...
CONSTRAINTS = [
    ...
    "thirteen — panel, quote_history, fund_nav, option_history, termo_history, "
    "financials, company_financials, income_statements, anbima_classes, "
    "inflation, inflation_items, fidc_tranches, fidc_aging "
    "(`limits.page.all`). "
    ...
    "two families in the same month. The other ten do not page: narrow "
...
def catalog_payload() -> Dict[str, Any]:
    return {
        ...
        "postgrest": {
            ...
            # FIDC structure (v31): tranches and the aging ladder, 2025-01 on.
