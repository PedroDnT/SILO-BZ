...
AS $$
    ...
    WITH landed AS (
        ...
        UNION ALL
        -- v36: cia_aberta logs cad, ipe, fca and the statements under one
        ...
        UNION ALL
        -- v36: the ptax row must not report an SGS success as PTAX freshness
    ...
    base AS (
        ...
        UNION ALL
        -- v36 (26_api_events_macro.sql). IPE filings, keyed on the DELIVERY
