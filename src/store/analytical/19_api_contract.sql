...
AS $$
    ...
    WITH landed AS (
        ...
        UNION ALL
        -- v37: cia_aberta logs cad, ipe, fca and the statements under one
        ...
        UNION ALL
        -- v37: the ptax row must not report an SGS success as PTAX freshness
    ...
    base AS (
        ...
        UNION ALL
        -- v37 (26_api_events_macro.sql). IPE filings, keyed on the DELIVERY
