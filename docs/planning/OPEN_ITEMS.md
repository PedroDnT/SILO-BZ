...
| 2c  | B4, field-level restatement diffs (`fnet_document_diff`): designed in [DOCUMENTS.md](DOCUMENTS.md), §11 decided 2026-09-26; slice 1 (FIDC mensal: migration 46, `fnet_diff_pipeline`, `api.fund_restatement_diff`, catalog v40) built 2026-09-26, its 2026 queue drains by dispatch | 1b                 |
