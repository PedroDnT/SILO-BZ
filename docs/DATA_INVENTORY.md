...
| ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bacen_expectativas` | the Focus survey | **No.** Ingested daily and read only by the `/macro` dashboard page. The IPCA set of `bacen_sgs` is served by `api.inflation` (v30) and the rest of `bacen_sgs` plus `bacen_ptax` by `api.macro_series` / `api.ptax` (v37) — see the served table above. Candidate: the Focus survey needs its own shape (indicator × horizon × statistic). |
