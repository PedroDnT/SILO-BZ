"""FII inf_mensal — COMPLEMENTO subtype (the key metrics + cotistas breakdown).
...
returns, dividend yield) — i.e. most of what cvm_fii_mensal's typed columns were made
for. The cotistas-by-investor-type breakdown remains in residual `raw` unless the UI
needs it typed.
"""
...
FIELD_MAP = {
    ...
    "vl_patrim_liq":         (["Patrimonio_Liquido"],                      "numeric"),
    ...
    # Cotistas-by-type columns (Numero_Cotistas_Pessoa_Fisica, ...) remain in residual raw.
}
